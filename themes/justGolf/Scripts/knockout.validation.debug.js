...
(function () {
    ...
    ko.validation.validateObservable = function (observable) {
        ...
        // if multiple rules and already invalid, flag as valid
        // in order to force ko to update the observable if 
        // it becomes invalid due to a different rule
        if (len > 1 && !observable.__valid__()) {
